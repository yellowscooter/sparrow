...
/**
 * ColumnDecorator for Display tag to format a date in {@link DateFormat#MEDIUM} format.
 * 
 * @author manishk
 * @since 1.0
 */
public class MediumDateFormatDecorator implements DisplaytagColumnDecorator {
