...
public class EditBookFormController extends SimpleFormController {
private static final transient Log logger = LogFactory.getLog(AddBookFormController.class); 
  ...
  protected Object formBackingObject(HttpServletRequest request) throws Exception {
    ...
    List categories = (List)categoryService.getCategoriesByProduct(prod);
    Set categorySet = new HashSet(categories);
    prod.setCategories(categorySet);
    return prod;
  ...
  protected ModelAndView onSubmit(HttpServletRequest request, HttpServletResponse response, Object command, BindException errors) throws Exception {
    ...
    model.put("message", "Product Saved.");
